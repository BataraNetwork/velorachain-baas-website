 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getOpenAPISpec as api_docs_openapi_getOpenAPISpec } from "~backend/docs/openapi";
...
export namespace docs {
    ...
    export class ServiceClient {
        ...
        public async getOpenAPISpec(): Promise<ResponseType<typeof api_docs_openapi_getOpenAPISpec>> {
            // Now make the actual call to the API
